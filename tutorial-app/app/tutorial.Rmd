...
Use the code below to decide what values you want to plug in, and then generate the data using these new coefficient values
```{r plug-in, exercise=TRUE}
A = 
B = 
C = 
```
...
# Remember, you are going to use these values in your generate_data() function. 
# But really you're just passing these values as coefficients to that function
# From before. 
```
...
```{r log-ods-hint}
# Remember to plug in your values of A, B, and C from above!
```
