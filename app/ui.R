           ...
           navlistPanel(
             ...
             tabPanel("When",
                      ...
                      fluidRow(
                        ...
                        column(6,
                          sliderInput("c1", "Coefficient (Predictive Power of Variable):", 0, 10, 0.5)
                        )
                      ),
