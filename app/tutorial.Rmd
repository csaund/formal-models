...
The graph you produced shows you a correlation of speed and distance datapoints. 
...
As you can see, while the line fits the data, it is not straight (linear), therefore does not allow us to make predictions. You will see how it differs from the visualisation of the linear regression later on. 
